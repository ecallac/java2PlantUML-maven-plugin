package com.globant.utils.plantuml.classes.goal;
...
import com.globant.utils.plantuml.classes.render.filters.ChainFilter;
...
import static com.globant.utils.plantuml.classes.render.filters.Filters.CHAIN_CLASSES_CUSTOM_NAME;
import static com.globant.utils.plantuml.classes.render.filters.Filters.CHAIN_RELATIONS_CUSTOM_NAME;
import static com.globant.utils.plantuml.classes.render.filters.Filters.CHAIN_RELATION_TYPE_CUSTOM_NAME;
import static com.globant.utils.plantuml.classes.render.filters.Filters.FILTERS;
 ...
 * </pre>
 * 
 * Available filter names and types are defined in {@link com.globant.utils.plantuml.classes.render.filters.Filters#FILTERS} Map
 * Read {@link com.globant.utils.plantuml.classes.render.filters.Filters} javadoc to understand the three types of filters
 * yuio can use.
 * 
...
public class Parse extends AbstractMojo {
     ...
     */
    @Parameter(property = "parse.thePackage", defaultValue = "com.globant.utils.plantuml.classes.structure")
    ...
    @Parameter(property = "parse.path")
    private String path;
    
    /**
     * renderType values: 
     * Default parse.renderType = ALL
     * parse.renderType = CLASS_BY_CLASS
     * parse.renderType = PACKAGE_BY_PACKAGE
     * 
     */
    @Parameter(property = "parse.renderType" , defaultValue = "ALL")
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        try {
            ...
            getLog().info("package:"+thePackage+" \n");
            getLog().info("rendeerType:"+renderType+" \n");
				getLog().info("Following is the PlantUML src: \n");
				Parser.parse(
	                    thePackage, FILTERS.get(this.relationTypeFilter), FILTERS.get(this.classesFilter),
	                    FILTERS.get(this.relationsFilter), loader,path,renderType);
