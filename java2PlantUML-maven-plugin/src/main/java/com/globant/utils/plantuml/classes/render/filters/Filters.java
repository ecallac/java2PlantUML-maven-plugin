...
public class Filters {
    ...
    /**
     * Can be assigned to {@link com.globant.utils.plantuml.classes.render.PlantRenderer#relationsTypeFilter}
     * that corresponds to {@link com.globant.utils.plantuml.classes.goal.Parse#relationTypeFilter}
     */
     ...
     * {@link com.globant.utils.plantuml.classes.render.PlantRenderer#relationsTypeFilter}
     */
    ...
    /**
     * Can be assigned to {@link com.globant.utils.plantuml.classes.render.PlantRenderer#relationsFilter}
     * that corresponds to {@link com.globant.utils.plantuml.classes.goal.Parse#relationsFilter}
     */
     ...
     * {@link com.globant.utils.plantuml.classes.render.PlantRenderer#relationsFilter}
     */
    ...
    /**
     * Can be assigned to {@link com.globant.utils.plantuml.classes.render.PlantRenderer#classesFilter}
     * that corresponds to {@link com.globant.utils.plantuml.classes.goal.Parse#classesFilter}
     */
     ...
     * {@link com.globant.utils.plantuml.classes.render.PlantRenderer#classesFilter}
     */
    ...
    public static final Map<String, Filter> FILTERS = new HashMap<String, Filter>();
    ...
    static {
        ...
        FILTER_FORBID_PRIMITIVES = new ForbiddenRexegFilter<Class<?>>();
        FILTER_FORBID_BASE_CLASSES = new ForbiddenRexegFilter<Class<?>>();

        FILTER_CHAIN_RELATION_STANDARD = new ChainFilter<Relation>();
        FILTER_CHAIN_RELATION_TYPE_STANDARD  = new ChainFilter<Class<? extends Relation>>();
        FILTER_CHAIN_CLASSES_STANDARD  = new ChainFilter<Class<?>>();
        FILTER_CHAIN_RELATION_TYPE_CUSTOM = new ChainFilter<Class<? extends Relation>>();
        FILTER_CHAIN_RELATION_CUSTOM = new ChainFilter<Relation>();
        FILTER_CHAIN_CLASSES_CUSTOM = new ChainFilter<Class<?>>();
        ...
        FILTER_FORBID_ENUM_AGGREGATION_LOOP = new PredicateFilter<Relation>(new Predicate<Relation>() {
            @Override
        ...
        FILTER_RELATION_FORBID_AGGREGATION_FROM_PRIVATE = new PredicateFilter<Relation>(new Predicate<Relation>() {
            @Override
            public boolean apply(@Nullable Relation relation) {
                return ! Aggregation.class.equals(relation.getClass())
